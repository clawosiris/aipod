...
|----------|---------|-------------|
| `USE_HOST_USER` | `true` | Use the current host username/uid/gid for the container user |
...
| `USER_UID` | current host uid | Container user uid override |
| `USER_GID` | current host gid | Container user gid override |
